...
public class PriorValueDecode {
	
	public static void main(String[] args) throws InsufficientBitsLeftException, IOException {
		// Re-use the starting structure code from the given decoders
		String input_file_name = "data/prior-value-compressed-voutput.dat";
		String output_file_name = "data/prior-value-uncompressed-voutput.dat";
		...
		int[] frame = new int[4096];
		
		// Use model 0 as initial model.
		FreqCountIntegerSymbolModel model = models[0]; 
		
		for (int i=0; i<num_symbols; i++) {
			// Use modular to get the parts of frames looped
			int index = i % 4096;
			model = models[frame[index]];
