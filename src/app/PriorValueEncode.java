...
public class PriorValueEncode {

	public static void main(String[] args) throws IOException {
		// Re-use the starting structure code from the provided encoders
		String input_file_name = "data/out.dat";
		String output_file_name = "data/prior-value-compressed-voutput.dat";
